...
from routers import predictions, backtest, rl_agent, news, metrics, ai_news, chatbot, email, explainability
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://alphasignal-frontend-qlbrqss62q-el.a.run.app",  # Production frontend
    ],
